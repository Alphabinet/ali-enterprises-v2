        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-10 mb-8 lg:mb-12">
          ...
          <div className="lg:col-span-7 flex flex-col gap-3">
            ...
            >
              ...
              {/* Counter Badge */}
              <div className="absolute top-3 right-3 bg-black/50 text-white text-[10px] font-bold px-2 py-1 rounded-full backdrop-blur-sm z-10">
              ...
              {/* Slide Controls (Always visible on mobile, hover on desktop) */}
              {displayImages.length > 1 && (
                <>
                  <button 
                    onClick={(e) => { e.stopPropagation(); handlePrev(); }}
                    className="absolute left-2 top-1/2 -translate-y-1/2 bg-white/90 text-slate-800 p-2 rounded-full shadow-lg backdrop-blur-sm transition-all active:scale-95 lg:opacity-0 lg:group-hover:opacity-100"
                  >
                    <ChevronLeft size={20} />
                  </button>
                  <button 
                    onClick={(e) => { e.stopPropagation(); handleNext(); }}
                    className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/90 text-slate-800 p-2 rounded-full shadow-lg backdrop-blur-sm transition-all active:scale-95 lg:opacity-0 lg:group-hover:opacity-100"
                  >
